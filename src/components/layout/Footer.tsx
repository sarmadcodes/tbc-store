        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/admin/login" className="text-gray-300 hover:text-white transition-colors">Admin</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">123 Industrial Area</p>
                  <p className="text-gray-300">Faisalabad, Punjab</p>
                  <p className="text-gray-300">Pakistan 38000</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@thebrokencolumn.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 TheBrokenColumn. All rights reserved.
            </p>
